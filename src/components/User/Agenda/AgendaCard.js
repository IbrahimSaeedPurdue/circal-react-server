...
const AgendaCard = ({ idString, meetingTitle, meetingRoom, meetingNotes, meetingTime, meetingDuration }) => {
      ...
      >
        ...
        <Card.Body>
          <Row className='position-relative'>
            <Col>
              <Card.Title className='pt-1 font-weight-bold text-gray'>{meetingTitle}</Card.Title>
            </Col>
          </Row>
